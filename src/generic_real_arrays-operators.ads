...
generic
    with package Elementary_Functions is new Ada.Numerics.Generic_Elementary_Functions(Float_Type => Real);
    with package Real_Functions is new Generic_Real_Functions (Float_Type => Real, Elementary_Functions => Elementary_Functions);
package Generic_Real_Arrays.Operators is
    pragma Preelaborate (Generic_Real_Arrays.Operators);
